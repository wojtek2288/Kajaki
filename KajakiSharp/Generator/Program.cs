...
internal class Program
{
    ...
    static void Main(string[] args)
    {
        ...
        GenerateInputFile(filename, peopleCount, pairCount);
    }

    static void GenerateInputFile(string filename, int peopleCount, int? pairCount) 
    {
    ...
    static (int p1, int p2) ConvertPairIdToPair(int id, int peopleCount)
    {
